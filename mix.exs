defmodule Liveup.MixProject do
  use Mix.Project
  ...
  defp deps do
    [
      ...
      {:kiosk_system_rpi4, "~> 0.4", runtime: false, targets: :rpi4},
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind liveup", "esbuild liveup"],
      "assets.deploy": [
        "tailwind liveup --minify",
        "esbuild liveup --minify",
        "phx.digest"
      ]
    ]
  end
